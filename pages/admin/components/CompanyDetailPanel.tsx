...
const StatCard: React.FC<{ title: string; value: number | string; icon: React.ReactNode }> = ({
  ...
  <div className="flex items-center gap-4 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
    <div className="bg-primary-100 dark:bg-primary-900/50 p-3 rounded-full">{icon}</div>
    <div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-xs">
                    {company.ownerUid || 'لم يسجل الدخول بعد'}
                  </span>
                </div>
            ...
            <Card>
              ...
              {!loadingStats && !stats && (
                <p className="text-gray-500 text-center">لا يمكن تحميل الإحصائيات.</p>
              )}
            </Card>
          </div>
        </div>
