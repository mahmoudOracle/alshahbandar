      ...
      >
        <header className="flex justify-between items-start pb-6 border-b">
          ...
          <div className="text-left">
            <h2 className="text-4xl font-bold uppercase text-gray-400 dark:text-gray-500">
              عرض سعر
            </h2>
        ...
        <section className="flex justify-between items-start mt-8">
          ...
          <div className="text-left">
            <p>
              <span className="font-semibold text-gray-700 dark:text-gray-300">تاريخ العرض:</span>{' '}
              {new Date(quote.date).toLocaleDateString('ar-EG')}
            </p>
            <p>
              <span className="font-semibold text-gray-700 dark:text-gray-300">صالح حتى:</span>{' '}
        ...
        <section className="flex justify-end mt-8">
          <div className="w-full md:w-1/2 lg:w-1/3 space-y-2">
            <div className="flex justify-between py-2">
              ...
              <span>
                {quote.subtotal.toFixed(2)} {settings.currency}
              </span>
            </div>
            {quote.taxAmount !== undefined && quote.taxAmount > 0 && (
              <div className="flex justify-between py-2">
                <span className="font-semibold text-gray-700 dark:text-gray-300">
                  الضريبة ({quote.taxRate || 0}%):
                </span>
                <span>
                  {quote.taxAmount.toFixed(2)} {settings.currency}
                </span>
              </div>
            )}
