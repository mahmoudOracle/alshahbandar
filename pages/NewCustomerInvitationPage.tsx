    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Create a new, separate company account for a customer. An invitation email will be sent to
          them directly.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end pt-4 border-t dark:border-gray-700">
            <button
              type="submit"
              disabled={loading}
              className="btn-primary flex items-center justify-center px-6 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:bg-blue-300"
            >
