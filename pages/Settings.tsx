  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div key={tax.id} className="grid grid-cols-12 gap-4 items-center">
                ...
                <div className="col-span-5">
                  <Input
                    ...
                    placeholder="المعدل %"
                    value={tax.rate}
                    onChange={(e) => handleTaxChange(index, 'rate', parseFloat(e.target.value))}
                  />
                </div>
        ...
        <Card header={<h3 className="text-xl font-bold">أقفال الدورات المحاسبية</h3>}>
          <fieldset disabled={!canWrite} className="space-y-4">
            <p className="text-sm text-gray-600">
              أغلق فترات محاسبية لمنع التعديلات على المستندات المؤرشفة. اختر شهرًا واحدًا لإضافته
              إلى قائمة الأقفال.
            </p>
            <div className="flex items-center gap-3">
              <input type="month" id="locked-period-input" className="form-input" />
              <Button
                type="button"
                onClick={() => {
            ...
            <div className="mt-3 space-y-2">
              {(settings.lockedPeriods || []).length === 0 ? (
                <p className="text-sm text-gray-500">لا توجد فترات مغلقة.</p>
              ) : (
