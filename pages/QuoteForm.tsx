...
type Action =
  ...
  | {
      type: 'UPDATE_ITEM';
      payload: { index: number; field: keyof QuoteItem; value: unknown; products: Product[] };
    }
  | { type: 'ADD_ITEM' }
    ...
    >
      ...
      <div className="border-t pt-6">
        ...
        <button
          type="button"
          onClick={addItem}
          className="flex items-center mt-4 px-3 py-2 text-sm font-medium text-blue-600 border border-blue-600 rounded-md hover:bg-blue-50 dark:text-blue-400 dark:border-blue-400 dark:hover:bg-gray-700"
        >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        <div>
          ...
          <select
            ...
            value={quote.taxRate}
            onChange={handleInputChange}
            className="mt-1 block w-full md:w-48 px-3 py-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600"
          >
        ...
        <div className="w-full md:w-1/3 space-y-2 text-lg">
          ...
          <div className="flex justify-between">
            <span>الضريبة ({quote.taxRate || 0}%):</span>
            <span>
