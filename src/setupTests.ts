    ...
    Object.defineProperty(window, 'matchMedia', {
        ...
        value: (query: string) => {
            return {
                ...
                media: query,
                onchange: null,
                addEventListener: (_: string, __: EventListener) => { /* noop */ },
                removeEventListener: (_: string, __: EventListener) => { /* noop */ },
                addListener: (_: (() => void) | null) => { /* noop */ },
                removeListener: (_: (() => void) | null) => { /* noop */ },
